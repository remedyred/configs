...
import eslintObjectNewline from '@ada-support/eslint-plugin-object-newline'
...
export const base = makeConfig(
		...
		FlatCompat.plugin('@ada-support/object-newline', eslintObjectNewline.configs.recommended)
)
